...
class File {
  ...
  set pos(pos) {
    ...
    const result = StormLib.SFileSetFilePointer(this.handle, pos, StormLib.NULLPTR, StormLib.FILE_BEGIN);
  ...
  read() {
    ...
    this.pos = 0;
    const success = StormLib.SFileReadFile(this.handle, this.data, size, StormLib.NULLPTR, StormLib.NULLPTR);
